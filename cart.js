...
function totalOfAllPro() {
  ...
  arry.map((element) => {
    ...
    console.log(parseFloat(all_values))
  });
...
function applyCoupon() {
  ...
  let a='newYearSale50'
  window.alert(`use this coupon 50 Off ${a}`)
  apply_btn.addEventListener("click", () => {

    if (couponInput.value === "newYearSale50") {
      let cartTotal = document.getElementById("cart-total");
        let couponTot = cartTotal.innerHTML -(cartTotal.innerHTML/2);
